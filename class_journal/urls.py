...
urlpatterns = [
    ...
    path('homework-submissions/', HomeworkSubmissionListView.as_view(),
         name='homework-submission-list'),
    path('homework-submissions/<int:pk>/',
         HomeworkSubmissionDetailView.as_view(), name='homework-submission-detail'),
